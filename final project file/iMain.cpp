...
void showScore()
{
	iShowBMP2(524, 490+15, score1[scoreIndex_1], 0);
	iShowBMP2(491, 490 + 15, score1[scoreIndex_2], 0);
	iShowBMP2(458, 490 + 15, score1[scoreIndex_3], 0);
	iShowBMP2(425, 490 + 15, score1[scoreIndex_4], 0);
}
...
void gameOver()
{
	if (replay)
	{
		...
		iShowBMP2(420, screenHeight - 495, score1[scoreIndex_4], 0);
		iShowBMP2(455, screenHeight - 495, score1[scoreIndex_3], 0);
		iShowBMP2(490, screenHeight - 495, score1[scoreIndex_2], 0);
		iShowBMP2(525, screenHeight - 495, score1[scoreIndex_1], 0);
...
void iDraw()
{
	...
	if (gameState == 0)
	{
		...
		if (levelState == -1)
		{
			...
			iShowBMP2(5, 5, "menu\\back.bmp", 0);
		}
		else if (levelState == 0)
		{
			iShowBMP(0, 0, "menu\\levelHardness.bmp");
			backButton();
		}
...
void iMouse(int button, int state, int mx, int my)
{
	...
	{
		if (mx >= 680 && mx <= 820 && my >= 561 - 412 && my <= 561 - 367)//replay 
		{
			replay = false;
			restartGame();
			playGame = true;
		...
		else if (mx >= 680 && mx <= 820 && my >= 561 - 490 && my <= 561 - 448)//back to menu
		{
			replay = false;
			restartGame();
			levelState = -1;
	...
	{
		if (mx >= 47 && mx <= 181 && my >= 561 - 550 && my <= 561 - 482)//resume the game
		{
			playGame = true;
			pauseIndex = 0;
		}
		else if (mx >= 200 && mx <= 333 && my >= 561 - 550 && my <= 561 - 482)//restart the game
		{
			replay = false;
			restartGame();
			playGame = true;
		...
		else if (mx >= 354 && mx <= 488 && my >= 561 - 550 && my <= 561 - 482)
		{
			replay = false;
			restartGame();
			levelState = -1;
	...
	if (gameState == 0 && levelState == -1)
	{
		if (mx >= 5 && mx <= 5 + 40 && my >= 5 && my <= 45)
		{
			gameState = -1;

		}
	}
	if (gameState == 0 && levelState != -1 && levelState != 0)
	{
		if (mx >= 5 && mx <= 5 + 40 && my >= screenHeight - 50 && my <= screenWidth - 10)
		{
			levelState = -1;
	...
	if (gameState == 0 && levelState == 0)
	{
		if (mx >= 266 && mx <= 402 && my >= screenHeight - 540 && my <= screenHeight - 475)
		{
			backgroundSpeed = 20;
			enemySpeed = 2;
			jumpSpeed = 5;
		...
		else if (mx >= 431 && mx <= 564 && my >= screenHeight - 540 && my <= screenHeight - 475)
		{
			backgroundSpeed = 25;
			enemySpeed = 7;
			jumpSpeed = 7;
		...
		else if (mx >= 593 && mx <= 726 && my >= screenHeight - 540 && my <= screenHeight - 475)
		{
			backgroundSpeed = 30;
			enemySpeed = 10;
			jumpSpeed = 10;
		...
		else if (mx >= 5 && mx <= 5 + 40 && my >= screenHeight - 50 && my <= screenWidth - 10)
		{
			levelState= -1;
